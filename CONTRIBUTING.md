...
To edit the Java or Kotlin files, open `example/android` in Android studio and find the source files at `capitual-react-native-android-pin-authentication` under `Android`.
